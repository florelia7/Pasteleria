...
<div class="js-product-slider-placeholder mobile-placeholder placeholder-figures-container product-placeholder-container m-bottom placeholder-container {% if product.images_count == 1 %}hidden-when-content-ready{% endif %}">
